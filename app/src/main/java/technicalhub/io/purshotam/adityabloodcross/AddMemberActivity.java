...
//                                    donorGender.setSelected(getGender(((String)d2.child("Gender").getValue())));
...
//    boolean getGender(String s){
//        List<String> list;
//        list = Arrays.asList(getResources().getStringArray(R.array.genderArray));
//        return true;
//    }
}
